...
editor.modal = {
  about: new MD.Modal({
    html: `
      ...
      <p>Magic Canvas is a simple vector drawing application. Magic Canvas was forked from <a href="https://github.com/SVG-Edit/svgedit">SVG-Edit</a> several years ago with the goal of improving and modernizing the interface.</p>
      `
  }),
  source: new MD.Modal({
    html: `
